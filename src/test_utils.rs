...
pub fn build_source_directory(name: &str) -> io::Result<PathBuf> {
...
pub fn build_target_directory(name: &str) -> io::Result<PathBuf> {
...
pub fn add_file_to(name: &str, path: &Path) -> io::Result<PathBuf> {
...
pub fn add_directory_to(name: &str, path: &Path) -> io::Result<PathBuf> {
...
pub fn with_test_directories(name: &str, test: impl FnOnce(&PathBuf, &PathBuf) -> () + std::panic::UnwindSafe) -> io::Result<()>  {
