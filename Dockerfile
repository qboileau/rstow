# inspired from https://www.fpcomplete.com/blog/2018/07/deploying-rust-with-docker-and-kubernetes article
...
RUN cp /target/release/rstow /build-out/
...
COPY --from=build /build-out/rstow /
